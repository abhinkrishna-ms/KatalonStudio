...
Mobile.tap(findTestObject('Object Repository/VBC PBP/android.widget.TextView - Start Application (1)'), 0)

Mobile.tap(findTestObject('Object Repository/VBC PBP/android.widget.TextView - Confirm (1)'), 0)
