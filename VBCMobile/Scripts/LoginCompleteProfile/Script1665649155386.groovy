...
//Mobile.setText(findTestObject('Login-logout/android.widget.EditText'), 'joshi@mailinator.com', 0)
//
//Mobile.setText(findTestObject('Login-logout/android.widget.EditText (1)'), 'Pass@123', 0)
//
//Mobile.tap(findTestObject('Object Repository/Login-logout/android.widget.TextView - Continue'), 0)
...
//
//Mobile.tap(findTestObject('Register-CompleteProfile/android.widget.EditText - 02'), 0)
//
//Mobile.setText(findTestObject('Object Repository/Register-CompleteProfile/android.widget.EditText - 02'), 01, 0)
//
//Mobile.tap(findTestObject('Register-CompleteProfile/android.widget.EditText - 2022'), 0, FailureHandling.STOP_ON_FAILURE)
//
//Mobile.setText(findTestObject('Register-CompleteProfile/android.widget.EditText - 2022'), '1996', 0)

Mobile.tap(findTestObject('Register-CompleteProfile/android.widget.EditText - 2022'), 0)
